...
//Name: ViperLabRoom_Test.0002.ma
//Last modified: Sat, Jan 27, 2018 03:15:48 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 25.61958181942888 21.283245100928955 -35.172784477036096 ;
	setAttr ".r" -type "double3" -21.338352768532637 2667.7999999975855 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "41864ED3-4764-C76D-15EB-2283A26E4BFF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 65.275419073850827;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "547C9909-4FA7-BDA9-26BD-BBB7C89E541B";
	setAttr -s 38 ".lnk";
	setAttr -s 38 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C811CA7B-4991-DD6A-3D38-2DB00C18A537";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CFC3FA27-4C7D-1539-1175-75A19A60144A";
createNode displayLayerManager -n "layerManager";
	rename -uid "A290AB79-46E5-1724-1436-689B50CB7274";
createNode displayLayer -n "defaultLayer";
	rename -uid "0BA6944E-4DC3-ED16-38C4-A2AFCDA4FE87";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E4D63BC5-4F71-47D4-312E-F99B494FB068";
...
// End of ViperLabRoom_Test.0002.ma
